...
const Newsletter = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center space-y-2 max-md:px-4 my-10 mb-40">
            <h1 className="md:text-4xl text-2xl font-semibold">Get on the Inside Track</h1>
            <p className="md:text-lg text-gray-500/70 pb-8">
            Be the first to receive our best deals, fleet updates, and special offers. Your key to a better rental is here.
            </p>
