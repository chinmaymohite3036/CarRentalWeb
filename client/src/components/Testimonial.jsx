    ...
    const dummyTestimonialData = [
        {
            ...
            name: 'Kartikeya Chavan',
            title: 'Software Engineer, IT Consultant',
            content: 'The booking process was seamless and the car was in pristine condition. Auro made our weekend getaway absolutely unforgettable!',
        },
        {
            image: assets.testimonial_image_2,
            name: 'Parth Pawar',
            title: 'Real Estate Developer',
            content: 'Absolutely fantastic service from start to finish. The team was incredibly professional and the car exceeded all of our expectations.',
        },
        {
            image: assets.testimonial_image_3,
            name: 'Parth Nehe',
            title: 'Sales Manager',
            content: 'Rented a sedan for a business trip. The car was clean, reliable, and the entire process was completely hassle-free. Highly recommend!',
        }
    ]
